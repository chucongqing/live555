...
TOOLS32	= C:\Program Files (x86)\Microsoft Visual Studio\2017\Community\VC\Tools\MSVC\14.15.26726
RCPATH = C:\Program Files (x86)\Windows Kits\10\bin\10.0.17763.0\x64

COMPILE_OPTS =		$(INCLUDES) $(cdebug) $(cflags) $(cvarsdll) -I. -I"$(TOOLS32)\include"
C =			c
C_COMPILER =		"$(TOOLS32)\bin\Hostx64\x64\cl"
