...
int setupStreamSocketWithAddr(UsageEnvironment& env, netAddressBits addr,
...
int setupStreamSocket(UsageEnvironment& env,
  ...
  return setupStreamSocketWithAddr(env, ReceivingInterfaceAddr, port, makeNonBlocking, setKeepAlive);
}
